	...
	function rincian($data,$idped){
		...
		foreach($results as $row){
			...
			$data['prods'][]=array(
				...
				'kode'=>null,
				 'stokawal'=>$stokawal,
				//'stokawal' => $row['id_persediaan'] =111 ? $lastdate[1]['saldomasuk_qty'] : $stokawal,
				'stokawalyard'=>0,
				...
				//'stokmasuk'=> $row['id_persediaan'] =111 ? $lastdate[0]['saldomasuk_qty']:(empty($stokmasuk['roll'])? $this->ReportModel->stokmasuk_alat_last($row['id_persediaan']) :$stokmasuk['roll']),
				'stokmasukyard'=>0,
