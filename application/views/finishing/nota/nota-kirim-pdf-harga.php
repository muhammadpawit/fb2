      ...
      <table border="1" style="border-collapse: collapse; width: 100%; border-color: #dee2e6 !important; font-size: 9pt !important;" cellpadding="2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">Rp. <?php $total += $gudang['harga_satuan'] * $gudang['jumlah_piece_diterima']; echo number_format($gudang['harga_satuan'] * $gudang['jumlah_piece_diterima']) ?></td>
                <td style="vertical-align: top;">
