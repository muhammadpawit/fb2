				...
				<tbody>
					...
					<?php foreach($prods as $k){?>
						<tr>
							...
							<td>
								<a href="<?php echo BASEURL?>Gajisablon/editbrongandalam/<?php echo $k['id']?>" class="btn btn-xs btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
								<a href="<?php echo BASEURL?>Gajisablon/hapusbrongandalam/<?php echo $k['id']?>" onclick="return confirm('Apakah yakin?')" class="btn btn-xs btn-danger btn-xs"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
					<?php $total+=($k['total']);?>
					<?php } ?>
