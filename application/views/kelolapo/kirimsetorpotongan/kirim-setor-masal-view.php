        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="m-t-0 header-title">Monitoring Kirim Setor Dan Sablon</h4>
                    <p>Pengirim ke cmt dari bagian qc ke cmt sablon</p>
                    <hr>
                   <div class="row">
                       <div class="col-12">
                           <a href="<?php echo BASEURL.'kelolapo/kirimmasalkecmt' ?>" class="btn btn-info">KIRIM MASAL</a>
                       </div>
                   </div>
                   <p class="text-muted font-14 m-b-30">
                    ...
                    <table id="datatable" class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($nota as $key => $sat): ?>
                            <tr>
                                <td><?php echo $sat['kode_nota_cmt'] ?></td>
                                <td><?php echo $sat['created_date'] ?></td>
                                <td>
                                    <a href="<?php echo BASEURL.'kelolapo/kirimnotmassalprint/'.$sat['kode_nota_cmt']; ?>" class="btn btn-secondary"> <i class="fa fa-print"></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
