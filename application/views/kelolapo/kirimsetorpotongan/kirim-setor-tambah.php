                ...
                <div class="card-box">
                   ...
                   <form action="<?php echo BASEURL.'kelolapo/kirimsetortambahAction' ?>" method="POST" enctype="multipart/form-data">
                   	<div class="row">
                        ...
                        <div class="col-4">
                        	<label>CMT</label>
                            <select class="form-control selectpicker" id="cmtKats" name="cmtKat" title="Select CMT" required data-live-search="true" required>
                        ...
                        <div class="col-2">
                            ...
                            <select class="form-control selectpicker" id="cmtNames" name="cmtName" required title="Select CMT name" data-live-search="true" required>
                                
                            </select>
                        </div>
                         <div class="col-2">
                            <label>CMT JOB</label>
                            <select class="form-control selectpicker" id="cmtJob" name="cmtJob"  title="Select CMT name" data-live-search="true" required>
                        ...
                        <div class="col-12">
                   		...
                   		<div class="form-group col-sm-12 col-lg-3">
                        	<label>Nama PO</label>
                            <select class="form-control selectpicker" id="poSelect" name="namaPo" required title="Select Nama PO" data-live-search="true" required>
                        ...
                        <div class="form-group col-sm-12 col-lg-3">
                        	...
                        	<input type="text" class="form-control timPotong" name="timPotong" readonly value="<?php echo $poProd['tim_potong_potongan'] ?>" required>
                        </div>
                        
                        <div class="form-group col-sm-12 col-lg-3">
                            <label>Jumlah Potong (Pcs)</label>
                            <input type="number" step="0.01" class="form-control jumlahPotPcs" name="jumlahPotPcs" value="<?php echo $parent['jumlah_total_potongan'] ?>" required>
                        </div>
                        <div class="form-group col-sm-12 col-lg-3">
                        	<label>Jml Warna</label>
                        	<input type="number" class="form-control jmlWarna" name="jmlWarna" readonly value="<?php echo $parent['jumlah_warna'] ?>" required>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="item_table">
                                ...
                                <tr>
                                    ...
                                    <td style="display: none;"><input type="hidden" class="form-control" name="qtyBankeAtas[]"  value="<?php echo $at['qty_bangke_atas'] ?>" required></td>
                            ...
                            <table class="table table-bordered" id="item_tabl2e">
                                ...
                                <?php foreach ($bawah as $key => $bw): ?>
                                	<tr>
                                        ...
                                        <td style="display: none;"><input type="hidden" class="form-control" name="qtyBankeBwh[]"  value="<?php echo $bw['qty_bangke_bwh'] ?>" required ></td>
...
$(document).on('click', '.add', function(){
    ...
    html += '<input type="hidden" class="form-control" name="qtyBankeAtas[]"  value="" >';
...
$(document).on('click', '.add2', function(){
    ...
    html += '<input type="hidden" class="form-control" name="qtyBankeBwh[]" value="">';
