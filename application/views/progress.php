                    ...
                    <table id="datatable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo BASEURL.'konveksi/produksipoedit/'.$sat['id_produksi_po'] ?>" class="btn btn-custom"> <i class="fa fa-edit"></i></a>
                                    <a href="<?php echo BASEURL.'konveksi/produksipodetail/'.$sat['id_produksi_po'] ?>" class="btn btn-danger"> <i class="fi-zoom-in"></i></a>
                                </td>
                            </tr>
                                <?php endforeach ?>
                        </tbody>
