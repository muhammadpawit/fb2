...
<div class="row">
    ...
    <div class="form-group col-md-4">
        <label>Nama PO</label>
        <select name="namaPo" id="namaPo" class="form-control select2bs4" data-live-search="TRUE" required>
            <option value=""></option>
            <?php foreach($po as $p){?>
...
<div class="row">
            ...
            <div class="col-md-6 mb-3">
                <div class="from-group">
                    ...
                    <input type="text" class="form-control" id="perkalianTarif" name="perkalianTarif" value="" required>
                </div>
            </div>
        </div>
