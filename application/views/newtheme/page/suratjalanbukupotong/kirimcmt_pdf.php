...
<div class="kiri" style="width: 500px;border:0px solid green;right:0px;position: absolute;padding-top: 50px">
	...
	<div style="border:1px solid black; border-collapse: collapse;display: inline-block;width:70%;float:right;padding:5px;">
		<div class="hs">Kepada Yth&nbsp;&nbsp;: <?php echo $kirim['idcmt']?></div>
		<div class="hs">Alamat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php ?></div>
		<div class="hs">Phone &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php ?></div>
...
<table style="border-collapse:collapse; width: 100%;border-color:1px solid #dee2e6 !important;">
	<thead>
		<tr>
			<th width="150" align="left"><small>No.<?php echo $kirim['nosj'] ?></small></th>
			<th colspan="4" align="left"><h3 style="margin-left: 200px;text-decoration: underline;">Surat Jalan Buku Potongan</h3></th>
		</tr>
	</thead>
</table>
		...
		<table style="width:100%">
			<tr>
				<td style="width:50%">
					<p>Keterangan :</p>
								<ol>
									<li><?php echo $kirim['keterangan']?></li>
								</ol>
				</td>
