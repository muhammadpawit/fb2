			...
			<table class="table table-bordered">
				...
				<tfoot>
					<tr>
						...
						<td>
							<input type="number" name="potongan_claim" id="potongan_claim" class="form-control" value="<?php echo isset($detail['potongan_claim']) ? $detail['potongan_claim'] : $totalclaim ?>" placeholder="0">
							<input type="hidden" name="total_klaim" id="total_klaim" value="<?php echo isset($detail['potongan_claim']) ? $detail['potongan_claim'] : $totalclaim?>">
							...
							<input type="hidden" name="total_diterima" id="base_total_diterima" value="<?php echo ($tjml+$total_tukang_borongan-(isset($detail['potongan_claim']) ? $detail['potongan_claim'] : $totalclaim))?>">
						</td>
					</tr>
				</tfoot>
			</table>
