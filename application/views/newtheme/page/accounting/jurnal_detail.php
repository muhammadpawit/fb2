  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Detail Jurnal: <?php echo $jurnal['no_jurnal'] ?></h3>
        ...
        <table class="table table-bordered">
          ...
          <tfoot>
            <tr style="font-weight: bold; background-color: #f4f4f4;">
              ...
              <td align="right"><?php echo number_format($jurnal['total_debit'], 2) ?></td>
              <td align="right"><?php echo number_format($jurnal['total_kredit'], 2) ?></td>
            </tr>
          </tfoot>
        </table>
      </div>
