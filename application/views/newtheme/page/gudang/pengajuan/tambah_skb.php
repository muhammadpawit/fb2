...
<script type="text/javascript">
    ...
    function itemajaun(){
        ...
        html += '<td><input type="hidden" size="12" class="form-control harga" name="products['+i+'][harga]" onblur="updatetotal('+i+')" value="0"></td>';
        //html+='<td><span class="total-'+i+'"></span></td>';
        html += '<td><input type="hidden" size="12" class="form-control" name="products['+i+'][pembayaran]" value="2"></td>';
        //html += '<td><input type="text" value="-" class="form-control" name="products['+i+'][supplier]"></td>';
        html+='<td><input type="hidden" size="12" class="form-control" name="products['+i+'][supplier]" value="2"></td>';
