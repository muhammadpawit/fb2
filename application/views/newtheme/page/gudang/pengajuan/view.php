                    ...
                    <tbody>
                        ...
                        <?php foreach ($harian as $key => $us): ?>
                            ...
                            <tr>
                                ...
                                <!-- <td><?php //echo number_format($us['cash'])
                                            ?></td>
                                <td><?php // echo number_format($us['transfer'])
                                    ?></td> -->
                                <?php if ($setujui == 1) { ?>
                                    <td>
...
<script>
    $(document).ready(function() {
        ...
        $('#save_signature').click(function() {
            var $sigdiv = window.currentSigPad || $("#signature-pad");
            if ($sigdiv.length == 0) $sigdiv = $(".jSignature").last();
