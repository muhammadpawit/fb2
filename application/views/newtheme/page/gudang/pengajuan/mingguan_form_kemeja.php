        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <input type="text" name="stok_skb" id="stok_skb" class="form-control" required="required">
            </div>
            <div class="col-md-4">
              <label>Ajuan</label>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.remove', function(){
    ...
    $(document).on('change', '.select2bs4', function(e){
            ...
            $.get( "<?php echo BASEURL.'Ajuanalatalat/cariproduct_stok_skb' ?>", { id: dataItem } )
              .done(function( data ) {
                var obj = JSON.parse(data);
                console.log(obj);
                $("#stok_skb").val(obj.stock);
                $("#stok_skb").attr("readonly",true);
            });
        });
