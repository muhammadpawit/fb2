                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card-box mb-0 widget-chart-two">
                                                <div class="float-right">
                                                    <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                                           data-fgColor="#0acf97" value="<?php echo $produkPO ?>" data-skin="tron" data-angleOffset="180"
                                                           data-readOnly=true data-thickness=".1"/>
                                                </div>
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Produksi PO</p>
                                                    <h3 class=""><?php echo $produkPO ?></h3>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-3">
                                            <div class="card-box mb-0 widget-chart-two">
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Kirim Gudang</p>
                                                    <h3 class=""><?php echo $kirimGudang ?></h3>
                                                </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-centered m-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?php echo ASSETS ?>images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?php echo ASSETS ?>images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?php echo ASSETS ?>images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?php echo ASSETS ?>images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?php echo ASSETS ?>images/users/avatar-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
