				...
				<div class="container">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="table-responsive-sm">
								...
								<?php foreach($kirims as $k){?>
									<tr>
										...
										<td class="no-print">
											<select name="prods[<?php echo $no?>][cmtjob]" class="form-control select2bs4" data-live-search="true" style="width: 100%">
							...
							<div class="row">
							<div class="col-12">
								<a href="<?php echo BASEURL.'Kelolapo/pengirimansablon'; ?>" class="btn btn-danger btn-sm">Kembali</a>
