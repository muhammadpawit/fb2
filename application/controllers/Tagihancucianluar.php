...
class Tagihancucianluar extends CI_Controller {
	...
	function __construct() {
		...
		$this->page='newtheme/page/tagihancucianluar/';
		$this->url=BASEURL.'tagihancucianluar/';
	}

	public function index()
	{
		$data=[];
		$data['title']='Tagihan Cucian Luar';
		$data['products']=array();
		$no=1;
		$get=$this->input->get();
		$url='';
		...
		$data['products']=array();
		$sql="SELECT * FROM cucian WHERE hapus=0 and idkaryawan IN(43) ";
		...
		$data['excel']=BASEURL.'tagihancucianluar?&excel=2'.$url;
