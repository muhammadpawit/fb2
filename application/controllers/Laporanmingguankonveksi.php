	...
	public function index(){
		...
		foreach (looping_tanggal($tanggal1,$tanggal2) as $dt) {
		    ...
		    $data['results'][]=array(
		    	...
		    	'giro'=>0,
		    	'kas'=>$masuk_kas,
		    	'bahanbaku'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,6),
		    	'ops'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,7),
		    	'gaji'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,8),
		    	'alokasitransfer'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,9),
		    	'sisa'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,10),
		    	'belanja'=>$this->LaporanmingguanModel->alokasi_bordir($dt['tanggal'],$bagian,11),
