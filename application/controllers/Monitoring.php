...
class Monitoring extends CI_Controller {
	...
	public function penjualan() {
		...
		foreach($arpo as $arp){
			$data['rekap'][]=array(
				...
				'total'=>$this->ReportModel->pcs_monitoring_kirimgudang_hargaLangsung($arp['id'],$tanggal1,$tanggal2),
			);
			$i++;
		}
		//pre($data['rekap']);
	...
	public function bahanmasuk()
	{
		...
		$data['supplier']=$this->GlobalModel->getData('master_supplier',array('hapus'=>0,'is_supplier_bahan'=>1));
		$data['n']=1;
