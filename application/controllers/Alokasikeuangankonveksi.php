...
class Alokasikeuangankonveksi extends CI_Controller {
	...
	function __construct() {
		...
		$this->url=BASEURL.'Alokasikeuangankonveksi/';
	}

	public function index(){
		$data=array();
		$data['title']='Alokasi Keuangan Konveksi';
		$data['n']=1;
		...
		$data['alokasi']=$this->GlobalModel->QueryManual("SELECT * FROM pengalokasian WHERE hapus=0 AND bagian=1 AND id NOT IN (17,18,19)");
