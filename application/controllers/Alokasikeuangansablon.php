...
class Alokasikeuangansablon extends CI_Controller {
	...
	function __construct() {
		...
		$this->url=BASEURL.'Alokasikeuangansablon/';
	...
	public function index(){
		$data=array();
		$data['title']='Alokasi Keuangan Sablon';
		$data['n']=1;
		...
		$data['alokasi']=$this->GlobalModel->QueryManual("SELECT * FROM pengalokasian WHERE hapus=0 AND bagian=3 AND id NOT IN (17,18,19)");
